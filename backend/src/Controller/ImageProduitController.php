...
final class ImageProduitController extends AbstractController
{
    ...
    public function index(ImageProduitRepository $imageProduitRepository): Response
    {
        return $this->render('image_produit/index.html.twig', [
            'image_produits' => $imageProduitRepository->findAll(),
        ]);
    }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $form = $this->createForm(ImageProduitForm::class, $imageProduit);
